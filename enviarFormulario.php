...
if (isset($_POST['enviarFormulario']))
{
	...
	nombrelevantador, fechadelito, tipodelito, otrodelito, localizacion, detallesdelito, nombredelincuente, detallesdelincuente, id_formulario,nombreafectado)
	VALUES ('$nombreLevantador', '$fechaDelito', '$tipoDelito', '$otroDelito', '$localizacion', '$detallesDelito', '$nombreDelincuente', '$detallesDelincuente', '$id_formulario','$nombreAfectado')";
